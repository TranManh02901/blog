        ...
        <Flex justifyContent="center" marginTop="10" marginBottom="10">
            <Grid bgColor="#333F50" h={50} border="1px"
                ...
                <GridItem colStart="4" colEnd="24"
                    rowStart="5" rowEnd="5">
                    <Text color="purple.500" fontSize="14">$ <Highlight query="dolphin" styles={{ color: "green.500" }}>dolphin </Highlight><Highlight query="works" styles={{ color: "blue.400" }}>works</Highlight> </Text>
                </GridItem>
            </Grid>
        </Flex>
    )
